...
func InitOptionMap() {
	...
	common.OptionMap["RecordIpLogEnabled"] = strconv.FormatBool(common.RecordIpLogEnabled)
	...
	common.OptionMap["ModelConcurrencyLimitCount"] = strconv.Itoa(setting.ModelConcurrencyLimitCount)
	common.OptionMap["ModelConcurrencyLimitGroup"] = setting.ModelConcurrencyLimitGroup2JSONString()
	common.OptionMap["ModelRateLimitExemptGroups"] = setting.ModelRateLimitExemptGroups2JSONString()
	...
	common.OptionMap["ModelConcurrencyLimitEnabled"] = strconv.FormatBool(setting.ModelConcurrencyLimitEnabled)
	common.OptionMap["CheckSensitiveOnPromptEnabled"] = strconv.FormatBool(setting.CheckSensitiveOnPromptEnabled)
	common.OptionMap["StopOnSensitiveEnabled"] = strconv.FormatBool(setting.StopOnSensitiveEnabled)
	common.OptionMap["SensitiveWords"] = setting.SensitiveWordsToString()
	common.OptionMap["StreamCacheQueueLength"] = strconv.Itoa(setting.StreamCacheQueueLength)
	common.OptionMap["AutomaticDisableKeywords"] = operation_setting.AutomaticDisableKeywordsToString()
	common.OptionMap["SyntheticCacheWriteModels"] = operation_setting.SyntheticCacheWriteModelsToString()
	common.OptionMap["LongContextTiers"] = operation_setting.LongContextTiersToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "ModelConcurrencyLimitEnabled":
			setting.ModelConcurrencyLimitEnabled = boolValue
	...
	case "ModelConcurrencyLimitCount":
		setting.ModelConcurrencyLimitCount, _ = strconv.Atoi(value)
	case "ModelConcurrencyLimitGroup":
		err = setting.UpdateModelConcurrencyLimitGroupByJSONString(value)
	case "ModelRateLimitExemptGroups":
		err = setting.UpdateModelRateLimitExemptGroupsByJSONString(value)
	case "RetryTimes":
	...
	case "SyntheticCacheWriteModels":
		operation_setting.SyntheticCacheWriteModelsFromString(value)
	case "LongContextTiers":
		err = operation_setting.LongContextTiersFromString(value)
